...
export const categories: Category[] = [
  ...
  { name: 'Χυμοί', slug: 'juices' },
  { name: 'Καφές', slug: 'coffee' },
  { name: 'Τσάγια', slug: 'teas' },
  { name: 'Γλυκά', slug: 'sweets' },
...
export const subcategories: Subcategory[] = [
  ...
  { name: 'Φυσική Ξήρανση', slug: 'natural-drying', categorySlug: 'dried-fruits' },
]
